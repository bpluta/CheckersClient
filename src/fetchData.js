const urlBase = "http://SERVER_IP:PORT";
...
function sendRequest(type, url, data, callback, onFail) {
  ...
  request.setRequestHeader("Content-type", "application/json"); // Wszystkie parametry ramki HTTP
  request.send(data!==null ? JSON.stringify(data) : null); // Dane POST
